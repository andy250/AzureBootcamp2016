...
class DeviceClient():
    ...
    def send(self, message):
        ...
        #req = urllib2.urlopen(self._base_url + 'events?' + self._API_VERSION,
        #                             message,
        #                             headers,
        #                             method = 'POST')

        f = requests.post(self._base_url + 'events?' + self._API_VERSION, message, headers = headers)
    ...
    def read_message(self):
        ...
        f = requests.get(self._base_url + 'devicebound?' + self._API_VERSION, headers = headers)
        
        # Process headers
        message['headers'] =  f.headers
        message['etag'] = ''
        if f.headers['ETag'] != None:
            message['etag'] = f.headers['ETag'].strip('"')
            
        # message
        message['body'] = f.text
        message['response_code'] = f.status_code
    ...
    def complete_message(self, id):
        ...
        f = requests.delete(self._base_url + 'devicebound/' + id + '?' + self._API_VERSION, headers = headers)
        return f.status_code
    ...
    def reject_message(self, id):
        ...
        f = request.delete(self._base_url + 'devicebound/' + id + '?reject&' + self._API_VERSION, headers = headers)
        return f.status_code
    ...
    def abandon_message(self, id):
        ...
        f = request.post(self._base_url + 'devicebound/' + id + '/abandon?' + self._API_VERSION, '', headers = headers)
        return f.status_code
